...
// Refactored analysis function that accepts data as an argument
export const analyseData = async (data) => {
  ...
  const prompt = `Please analyze the following stock data: ${JSON.stringify(data, getCircularReplacer())}`;
